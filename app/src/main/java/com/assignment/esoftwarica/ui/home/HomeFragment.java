...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Niraj Shrestha", "Boudha", "Male", "25", R.drawable.maleimg));
            studentsList.add(new Students("Oshin Ghale", "Swayambhu", "Female", "22", R.drawable.femaleimg));
